            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "Forget any previous context. You are an action planning agent. Using your knowledge, "
                        "you extract from the user prompt the steps requested to complete "
                        "the action the user is asking for. You return the steps as a list. "
